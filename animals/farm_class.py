...
_DOGS = [["Рэкс", 15, 3, "Немецкая овчарка"], ["Бутч", 35, 2, "Шарпей"], ["Джек", 10, 4, "Немецкий дог"],
         ["Тузик", 12, 6, "Такса"], ["Лиза", 11, 5, "Вельш корги"], ["Шарик", 8, 6, "Мопс"],
         ["Вьюга", 45, 5, "Кавказская овчарка"], ["Юля", 43, 5, "Шпиц"],
         ]
